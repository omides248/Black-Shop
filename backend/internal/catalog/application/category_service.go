...
func (s *Service) CreateCategory(ctx context.Context, name string, imageUrl, parentID *string) (*domain.Category, error) {
...
func (s *Service) validateParentCategory(ctx context.Context, parentID *string) (*domain.Category, error) {
...
func (s *Service) checkDuplicateCategoryName(ctx context.Context, name string, parentCategory *domain.Category) error {
