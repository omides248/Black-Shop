...
func NewCartRepository(client *redis.Client, logger *zap.Logger) order.CartRepository {
	return &cartRepo{
		client: client,
...
func (r *cartRepo) Save(ctx context.Context, cart *order.Cart) error {
...
func (r *cartRepo) GetByUserID(ctx context.Context, userID string) (*order.Cart, error) {
